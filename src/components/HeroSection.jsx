...
const HeroSection = () => {
  return (
    <div>
      <div className=" lg:bg-[url(./assets/images/headerimg.webp)] Hero-img ">
        <div className="bg-heroGradient lg:bg-none relative z-20 ">
          ...
          <div className="   container max-w-[1160px] 2xl:max-w-[1320px] mx-auto ps-3 pe-5 md:pt-[80px] pb-[30px] lg:pt-[160px] xl:pt-[229px] 2xl:pt-[250px] md:pb-[100px] lg:pb-[150px] xl:pb-[200px] ">
            <div className="flex md:flex-row flex-wrap -mx-3 items-center  ">
              <div className="md:w-6/12 w-full px-3 pb-[55px] md:pb-0">
                ...
                <div className="flex gap-[15px] pt-[40px]">
                  <button className=" bg-[#fff] text-orange-400 sm:text-base text-[14px] font-Montserrat font-semibold leading-normal border border-transparent  rounded-[40px] px-[12px] sm:px-[16px] lg:px-[21px] py-[10px] hover:bg-transparent hover:border hover:border-white hover:text-white transition-all ease-linear duration-300">
                    How To Buy
                  </button>
                  <button className="text-white font-Montserrat sm:text-base text-[14px] leading-normal font-semibold  bg-transparent border border-[#fff] py-[10px] px-[12px] sm:px-[16px] lg:px-[21px] rounded-[40px] hover:bg-transparent hover:border hover:border-transparent hover:bg-white hover:text-orange-400 transition-all ease-linear duration-300">
                    Read Whitepaper
                  </button>
                </div>
              </div>
              <div className="md:w-6/12 w-full px-3 pt-14 sm:py-12 md:pt-0">
                <div className="flex md:block justify-center">
                  <img
                    className="w-full sm:w-4/5 animate-whitePaper "
                    src={HeroMain}
                    alt="hero"
                  />
                </div>
                <div className="absolute lg:hidden  bottom-0 sm:bottom-[5%] right-0 -z-10  flex justify-end">
                  <img

  ...
  return (
    <div className="relative z-10">
      ...
      <div className="container max-w-[1320px] mx-auto px-3 py-[48px] sm:py-[60px] md:py-[80px]">
        <h2 className="text-center font-Montserrat font-bold text-[35px] sm:text-[45px] md:text-[50px] text-[#32352C] pb-[22px]">
          Tokenomics
        </h2>
        <div
        ...
        >
          ...
          <p
            className="
          font-Montserrat font-bold text-[20px] sm:bg-transparent sm:py-0 bg-[#8CC63F] mt-3 sm:mt-0 text-white rounded-[10px] py-3 sm:text-[#32352C]  sm:max-w-[180px] text-center sm:text-end sm:absolute sm:bottom-[15%] lg:bottom-[30%] lg:left-[-15%]"
          >
